    ...
    <Sidebar collapsible="icon" {...props}>
      ...
      <SidebarContent>
        <SidebarGroup>
          <SidebarMenu>
            <SidebarMenuItem>
              <SidebarMenuButton asChild tooltip={'마이페이지'}>
                <Link href="/mypage">
                  <User />
                  <span>마이페이지</span>
                </Link>
            ...
            <SidebarMenuItem>
              <SidebarMenuButton asChild tooltip={'AI 금융 리포트 생성'}>
                <Link href="/report">
                  <Bot />
            ...
            <SidebarMenuItem>
              <SidebarMenuButton asChild tooltip={'퐁 스토어'}>
                <Link href="/store">
                  <ShoppingBag />
                  <span>퐁 스토어</span>
                </Link>
            ...
            <SidebarMenuItem>
              <SidebarMenuButton asChild tooltip={'기부하기'}>
                <Link href="/donation">
                  <Gift />
                  <span>기부하기</span>
                </Link>
