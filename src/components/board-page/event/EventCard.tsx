...
export default function EventCard({ e, onClick }: { e: EventMeta; onClick: () => void }) {
  return (
    <Card
      onClick={onClick}
      className={cn('hover:shadow-badge cursor-pointer rounded-xl transition-shadow duration-300')}
    >
